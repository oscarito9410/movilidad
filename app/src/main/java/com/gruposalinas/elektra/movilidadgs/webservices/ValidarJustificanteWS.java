...
{
    public static String TAG = "checar ValidarJustificacion";
    String line=null;
    ...
    {
       // String URL="http://10.112.51.5:8083/ServicioEmpleados.svc/ValidarJustificante";// DESARROLLO
      // String URL="http://200.38.122.208:8081/ServicioEmpleados.svc/ValidarJustificante";
        ...
        try {
            a.put("token", Encryption.md5(incidencias.getD_num_empleado_justifica() + Encryption.getHour())+"");
            a.put("id_num_empleado", incidencias.getD_num_empleado_justifica()+"");
