...
public class Agregar_permisos_plantilla extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_permisos_plantilla);
        init();
        action_boton();
    }
...
//        Validar= bundle.getString("nombre");
    ...
    private void action_boton()
    {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(Agregar_permisos_plantilla.this, Permisos_Plantilla_Activity.class);
        ...
        cotacto_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(Agregar_permisos_plantilla.this, Contacto.class);
                startActivity(intent);
            }
        });
        ...
        ubicacion_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                drawerLayout.closeDrawer(GravityCompat.START);
                Intent intent = new Intent(Agregar_permisos_plantilla.this, Activity_Tiendas.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
            }
        ...
        menu_horario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(Agregar_permisos_plantilla.this, Horarios_consulta.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
        ...
        incidencias_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(Agregar_permisos_plantilla.this,ListaIncidenciasActivity.class);
        ...
        agregarPermiso.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                String b=empleados.getText().toString();
                ...
                permisos.setId_numero_empleado(s[0].trim());

                    permisos.setTipo("Línea directa");
    ...
    public void mostrar(String lis[], final TextView textView)
    {
        ...
        final Dialog alert = new Dialog(Agregar_permisos_plantilla.this,R.style.Theme_Dialog_Translucent);
    ...
    public void exito(Permisos permisos)
    {
        ...
        if(permisos.isSuccess())
        {
            ...
            alertas.alertas("Error de conexión intentar más tarde.",Agregar_permisos_plantilla.this);
        }
    ...
    public void alertas(){
        ...
        textView.setText(empleados.getText().toString());
        texto.setText("Se asigno el permiso \ncorrectamente a:");
        alert.setContentView(dialogo);
    ...
    public void mostar(Permisos permisos)
    {
            ...
            if(permisos.isSuccess())
            {
                ...
                for (int t = 0; t < da.length(); t++) {
                    ...
                    try {
                        ...
                        alertas.alertas("Error de conexión",this);
                    }

                }
                empleados.setText(arrayList.get(0));
                ...
                alertas.alertas("error de conexión intente más tarde", this);
